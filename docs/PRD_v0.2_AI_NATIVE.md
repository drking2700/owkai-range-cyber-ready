...
**Status:** ACTIVE — AI-Native Design Freeze / Pre-Build  
...
**Overall:** AI-NATIVE DESIGN FREEZE / PRE-BUILD
...
**In Progress:** PRD v0.2 approval and AI-native design freeze.

**Next:**
1. Approve PRD v0.2 AI-native direction.
2. Reconcile source-of-truth documents.
3. Finalize the AI Operating Doctrine and AI evidence standard.
4. Fully specify AI-native Missions 1, 5, and 9.
5. Define learner AI-assistance access/privacy/cost model.
6. Prepare sanitized training snapshot.
7. Assemble Gate 1 evidence.
8. Begin vertical slice only after Gate 1 approval.
